...
otutab <- read.csv("../Paired_only/03_Obitools3_Results/MiFish_named_tab_LULU.txt", sep='\t', header=TRUE, as.is=TRUE, row.names = 1) 
matchlist <- read.table("../Paired_only/03_Obitools3_Results/MiFish_named_matchlist.txt", header=FALSE, as.is=TRUE, stringsAsFactors=FALSE)
...
write.csv(curated_result$curated_table,"data/Paired/05_MetabaR_inputs/lulu_curated_MiFish_named.tab")
...
#taxonomy
MiFish_named_obi3_results<-read.csv("../Paired_only/03_Obitools3_Results/MiFish_named.tab", sep="\t")
MiFish_named_obi3_results<-MiFish_named_obi3_results%>% select(id, BEST_IDENTITY, TAXID, SCIENTIFIC_NAME, ID_STATUS,sequence)
...
write.csv(Metabar_formatted_reads, "data/Paired/05_MetabaR_inputs/MiFish_Metabar_formatted_reads.csv")
write_delim(Metabar_formatted_motus, "data/Paired/05_MetabaR_inputs/MiFish_Metabar_formatted_motus.txt")
write_delim(Metabar_formatted_pcrs, "data/Paired/05_MetabaR_inputs/MiFish_Metabar_formatted_pcrs.txt")
write_delim(Metabar_formatted_samples, "data/Paired/05_MetabaR_inputs/MiFish_Metabar_formatted_samples.txt")
...
write.csv(NC_MiFish_clean$reads, "data/Paired/06_Metabar_results/NC_MiFish_obi3_lulu_metabar_reads.csv")
write.csv(NC_MiFish_clean$motus, "data/Paired/06_Metabar_results/NC_MiFish_obi3_lulu_metabar_reads.csv")
write.csv(NC_MiFish_clean$pcrs, "data/Paired/06_Metabar_results/NC_MiFish_obi3_lulu_metabar_reads.csv")
write.csv(NC_MiFish_clean$samples, "data/Paired/06_Metabar_results/NC_MiFish_obi3_lulu_metabar_reads.csv")
...
#blacknose
write.csv(NC_MiFish_C.acronotus_no_cannibals$reads, "data/Paired/06_Metabar_results/NC_MiFish_C.acronotus_no_cannibals_metabar_reads.csv")
write.csv(NC_MiFish_C.acronotus_no_cannibals$motus, "data/Paired/06_Metabar_results/NC_MiFish_C.acronotus_no_cannibals_metabar_motus.csv")
write.csv(NC_MiFish_C.acronotus_no_cannibals$pcrs, "data/Paired/06_Metabar_results/NC_MiFish_C.acronotus_no_cannibals_metabar_pcrs.csv")
write.csv(NC_MiFish_C.acronotus_no_cannibals$samples, "data/Paired/06_Metabar_results/NC_MiFish_C.acronotus_no_cannibals_metabar_samples.csv")




#blacktips
write.csv(NC_MiFish_C.limbatus_no_cannibals$reads, "data/Paired/06_Metabar_results/NC_MiFish_C.limbatus_no_cannibals_metabar_reads.csv")
write.csv(NC_MiFish_C.limbatus_no_cannibals$motus, "data/Paired/06_Metabar_results/NC_MiFish_C.limbatus_no_cannibals_metabar_motus.csv")
write.csv(NC_MiFish_C.limbatus_no_cannibals$pcrs, "data/Paired/06_Metabar_results/NC_MiFish_C.limbatus_no_cannibals_metabar_pcrs.csv")
write.csv(NC_MiFish_C.limbatus_no_cannibals$samples, "data/Paired/06_Metabar_results/NC_MiFish_C.limbatus_no_cannibals_metabar_samples.csv")

#sharpnose
write.csv(NC_MiFish_R.terraenovae_no_cannibals$reads, "data/Paired/06_Metabar_results/NC_MiFish_R.terraenovae_no_cannibals_metabar_reads.csv")
write.csv(NC_MiFish_R.terraenovae_no_cannibals$motus, "data/Paired/06_Metabar_results/NC_MiFish_R.terraenovae_no_cannibals_metabar_motus.csv")
write.csv(NC_MiFish_R.terraenovae_no_cannibals$pcrs, "data/Paired/06_Metabar_results/NC_MiFish_R.terraenovae_no_cannibals_metabar_pcrs.csv")
write.csv(NC_MiFish_R.terraenovae_no_cannibals$samples, "data/Paired/06_Metabar_results/NC_MiFish_R.terraenovae_no_cannibals_metabar_samples.csv")


#bonnetheads
write.csv(NC_MiFish_S.tiburo_no_cannibals$reads, "data/Paired/06_Metabar_results/NC_MiFish_S.tiburo_no_cannibals_metabar_reads.csv")
write.csv(NC_MiFish_S.tiburo_no_cannibals$motus, "data/Paired/06_Metabar_results/NC_MiFish_S.tiburo_no_cannibals_metabar_motus.csv")
write.csv(NC_MiFish_S.tiburo_no_cannibals$pcrs, "data/Paired/06_Metabar_results/NC_MiFish_S.tiburo_no_cannibals_metabar_pcrs.csv")
write.csv(NC_MiFish_S.tiburo_no_cannibals$samples, "data/Paired/06_Metabar_results/NC_MiFish_S.tiburo_no_cannibals_metabar_samples.csv")
...
df.BerryCrust_results.reads<-read.csv("data/Paired/06_Metabar_results/NC_BerryCrust_obi3_lulu_metabar_reads.csv")
...
write_delim(df.NC_Sharks_results_merged_reads1, "data/Paired/06_Metabar_results/NC_Sharks_merged_final_reads.txt")
...
#get the results from the BerryCrust NC_Sharks R script with Metabar
df.BerryCrust_results.motus<-read.csv("data/Paired/06_Metabar_results/NC_BerryCrust_obi3_lulu_metabar_motus.csv")
...
write_delim(df.NC_Sharks_results_merged_motus1, "data/Paired/06_Metabar_results/NC_Sharks_merged_final_motus.txt")
...
#get the results from the BerryCrust NC_Sharks R script with Metabar
df.BerryCrust_results.pcrs<-read.csv("data/Paired/06_Metabar_results/NC_BerryCrust_obi3_lulu_metabar_pcrs.csv")
...
write_delim(df.NC_Sharks_results_merged_pcrs1, "data/Paired/06_Metabar_results/NC_Sharks_merged_final_pcrs.txt")
...
#get the results from the BerryCrust NC_Sharks R script with Metabar
df.BerryCrust_results.samples<-read_csv("data/Paired/06_Metabar_results/NC_BerryCrust_obi3_lulu_metabar_samples.csv")
...
write_delim(df.NC_Sharks_results_merged_samples1, "data/Paired/06_Metabar_results/NC_Sharks_merged_final_samples.txt")
...
saveRDS(NC_Combined, file = "data/Paired/06_Metabar_results/Paired_NC_Combined_metabarlist.rds")
...
ggsave("data/Paired/06_Metabar_results/PCA_of_Paired_NC_Sharks_Diets.jpg")
...
write.csv(clean.otu.df, "data/Paired/07_Phyloseq/combined_NC_Sharks_ready_for_phyloseq_otus.csv")
write.csv(samples.df, "data/Paired/07_Phyloseq/combined_NC_Sharks_ready_for_phyloseq_samples.csv")
write.csv(taxa.df, "data/Paired/07_Phyloseq/combined_NC_Sharks_ready_for_phyloseq_taxa.csv")

saveRDS(NC_Sharks.ps, file="data/Paired/07_Phyloseq/Paired_NC_Sharks.ps")
NC_Sharks.ps
...
ggsave("data/Paired/07_Phyloseq/Bar_Chart_of_Species_by_PreyGenus.jpg")
