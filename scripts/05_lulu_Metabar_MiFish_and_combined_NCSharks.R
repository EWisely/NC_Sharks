...
write.csv(curated_result$curated_table,"lulu_curated_MiFish_named.tab")
...
#samples
Metabar_formatted_pcrs<-read.csv("../MetabaR/MetabaR_formatted_pcrs_NCSharks_MiFish.txt", sep="\t")
...
#taxonomy
MiFish_named_obi3_results<-read.csv("MiFish_named.tab", sep="\t")
...
write.csv(Metabar_formatted_reads, "MiFish_Metabar_formatted_reads_pureobi3_lulu.csv")
write.csv(Metabar_formatted_motus, "MiFish_Metabar_formatted_motus_pureobi3_lulu.csv")
write.csv(Metabar_formatted_pcrs, "MiFish_Metabar_formatted_pcrs_pureobi3_lulu.csv")
write.csv(Metabar_formatted_samples, "MiFish_Metabar_formatted_samples_pureobi3_lulu.csv")
...
NC_MiFish<-tabfiles_to_metabarlist(
  file_reads= "MiFish_Metabar_formatted_reads_pureobi3_lulu.txt",
  file_motus= "MiFish_Metabar_formatted_motus_pureobi3_lulu.txt",
  file_pcrs ="MiFish_Metabar_formatted_pcrs_pureobi3_lulu_noSt9.txt",
...
df.BerryCrust_results.reads<-read.csv("~/Desktop/Savannah/following_obitools3_method/results_obi3-12-21-22/NC_BerryCrust_obi3_lulu_metabar_reads.csv")
...
#get the results from the BerryCrust NC_Sharks R script with Metabar
df.BerryCrust_results.motus<-read.csv("~/Desktop/Savannah/following_obitools3_method/results_obi3-12-21-22/NC_BerryCrust_obi3_lulu_metabar_motus.csv")
...
#get the results from the BerryCrust NC_Sharks R script with Metabar
df.BerryCrust_results.pcrs<-read.csv("~/Desktop/Savannah/following_obitools3_method/results_obi3-12-21-22/NC_BerryCrust_obi3_lulu_metabar_pcrs.csv")
...
#get the results from the BerryCrust NC_Sharks R script with Metabar
df.BerryCrust_results.samples<-read_csv("~/Desktop/Savannah/following_obitools3_method/results_obi3-12-21-22/NC_BerryCrust_obi3_lulu_metabar_samples.csv")
