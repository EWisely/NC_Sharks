...
load("data/06_MetabaR_results/After_BerryCrust_obi3_lulu_metabaR.RData")
...
samples.df1<-read.csv("data/05_MetabaR_inputs/newfilewithpairedcolumn.csv",row.names = "X")
NC_Sharks.ps<- phyloseq(otu_table(clean.otu.mat, taxa_are_rows = TRUE), 
                        sample_data(samples.df1), 
                        tax_table(clean.taxa.mat))
...
ggplot2::ggsave("data/07_Phyloseq_results_and_Visualizations/alpha_diversity_measures_by_species_and_material.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/Bar_Chart_of_Species_by_top20preyGenus.jpg")
###############
...
ggsave("data/07_Phyloseq_results_and_Visualizations/Bar_Chart_of_Species_by_PreyClass.jpg")

plot_bar(NC_Sharks.ps.med.norm, fill = "genus", facet_grid = "Species..scientific.name.")+ 
  geom_bar(aes(color=genus, fill=genus), stat="identity", position="stack")
ggsave("data/07_Phyloseq_results_and_Visualizations/Faceted_sample_species_prey-genus.jpg")

plot_bar(NC_Sharks.ps.med.norm, fill = "family", facet_grid = "Species..scientific.name.")+ 
  geom_bar(aes(color=family, fill=family), stat="identity", position="stack")
ggsave("data/07_Phyloseq_results_and_Visualizations/Faceted_sample_species_prey-family.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/Stomachs_vs_Fecals_for_Each_Species_by_prey_genus.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/alpha_diversity_measures_by_species_and_material.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/Bar_Chart_of_Species_by_top20preySpecies_incl_NA.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/Stomachs_vs_Fecals_for_Each_Species_by_prey_genus1.jpg")
...
plot_bar(NC_Shark_prey_species_merge_paired.ps.prop,x="sample_id", fill="genus") + 
  ...
  geom_bar(aes(color=genus, fill=genus), stat="identity", position="stack")
ggsave("data/07_Phyloseq_results_and_Visualizations/paired_samples_read_proportions_by_shark_species_prey_genus.jpg")


plot_heatmap(NC_Shark_prey_species_merge.ps.prop, method = "NMDS", distance = "bray", taxa.label = "species", sample.label="sample_id")
ggsave("data/07_Phyloseq_results_and_Visualizations/heatmap_sharkID_by_species_proportions.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/read_proportions_by_shark_species_prey_genus.jpg")

plot_heatmap(NC_Shark_prey_species_merge.ps.prop, method = "NMDS", distance = "bray", taxa.label = "genus" )
ggsave("data/07_Phyloseq_results_and_Visualizations/heatmap_sample_by_prey_genus_proportions.jpg")

plot_richness(NC_Shark_prey_species_merge.ps, x="Fork.Length..FL..mm..", color="Species..scientific.name.", measures=c("Observed"))

ggsave("data/07_Phyloseq_results_and_Visualizations/alpha_diversity_prey_richness_by_fork_length_all_species.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/prey_species_diversity_obs_Shannon_by_Shark_species.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/stacked_bar_chart_top20species_level_prey_by_shark_species.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/presence_absence_diet_PCA.jpg")
...
ggsave("data/07_Phyloseq_results_and_Visualizations/PCA_of_diet_composition_with_arrows.jpg")
