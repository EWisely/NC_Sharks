...
samples.df1<-read.csv("newfilewithpairedcolumn.csv",row.names = "X")
NC_Sharks.ps<- phyloseq(otu_table(clean.otu.mat, taxa_are_rows = TRUE), 
...
ggsave("alpha_diversity_measures_by_species_and_material.jpg")
...
ggsave("Stomachs_vs_Fecals_for_Each_Species_by_prey_genus.jpg")
...
ggsave("Bar_Chart_of_Species_by_top20preySpecies_incl_NA.jpg")
...
ggsave("Stomachs_vs_Fecals_for_Each_Species_by_prey_genus1.jpg")
...
plot_bar(NC_Shark_prey_species_merge_paired.ps.prop,x="sample_id", fill="genus") + 
  ...
  geom_bar(aes(color=genus, fill=genus), stat="identity", position="stack")
ggsave("paired_samples_read_proportions_by_shark_species_prey_genus.jpg")


plot_heatmap(NC_Shark_prey_species_merge.ps.prop, method = "NMDS", distance = "bray", taxa.label = "species", sample.label="sample_id")
ggsave("heatmap_sharkID_by_species_proportions.jpg")
...
ggsave("prey_species_diversity_obs_Shannon_by_Shark_species.jpg")
...
ggsave("stacked_bar_chart_top20species_level_prey_by_shark_species.jpg")
...
ggsave("presence_absence_diet_PCA.jpg")
...
ggsave("PCA_of_diet_composition_with_arrows.jpg")
