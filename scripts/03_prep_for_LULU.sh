...
#BerryCrust
obiannotate --seq-rank ../03_Obitools3_Results/crustaceans_results.fasta | obiannotate --set-identifier '"BerryCrust_%07d" % seq_rank' > BerryCrust_named.fasta
#sanity check
...
conda activate obitools
obiannotate --seq-rank ../03_Obitools3_Results/fish_results.fasta | obiannotate --set-identifier '"MiFish_%07d" % seq_rank' > MiFish_named.fasta
